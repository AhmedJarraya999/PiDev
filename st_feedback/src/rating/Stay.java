...
public class Stay {
    ...
    public Stay(int stay_id, int capacity, int idhost, String description, Date startdate_availability, Date enddate_availability) {
    ...
    public String toString() {
        return "Stay{" + "stay_id=" + stay_id + ", capacity=" + capacity + ", idhost=" + idhost + ", description=" + description + ", startdate_availability=" + startdate_availability + ", enddate_availability=" + enddate_availability + '}'+"\n";
    }
